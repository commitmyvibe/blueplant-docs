...
Die **Rolle** legt fest, was eine Person in blueplant tun und sehen darf. So sieht eine planende Person zum Beispiel die Terminplanung, ein Techniker dagegen vor allem seine eigenen Termine in der App. Es gibt diese Rollen:
...
| **Pflege** | Technikerin oder Techniker vor Ort – arbeitet vor allem in der App. |
...
<AccordionGroup>
  ...
  <Accordion title="Schnelle Erfassung von Pflegeergebnissen">
    Erlaubt unterwegs die vereinfachte Dokumentation mehrerer Pflanzen auf einmal (siehe [Produkte scannen & fastCare](/unterwegs/scannen-fastcare)).
  </Accordion>
...
{/* TODO: Screenshot Mitarbeiter-Anlegen-Maske (Test-Mandant) einfügen */}
{/* TODO: Screenshot Verfügbarkeits-Board (Test-Mandant) einfügen */}
